...
public class Inventario extends javax.swing.JFrame {
    ...
    //    this.setUndecorated(true);
      ...
      //  mostrar.BuscarDimesional(Dimensionaljcmb);
        Productojcmb.addItem("Bebederos manuales");
        Productojcmb.addItem("Jaulas");
        Productojcmb.addItem("Comederos");
        Productojcmb.addItem("Desinfectantes");
    ...
    public void transparenciButton() {
        ...
        String texto3 = "Agregar Producto";
        AgregarProductobtn.setToolTipText(texto3);
        String texto4 = "Agregar";
        AgregarDimensionalbtn.setToolTipText(texto4);
        String texto5 = "Haga click para acceder a Eliminación de Insumo";
        Guardarbtn1.setToolTipText(texto5);
        String texto6 = "Guardar Insumo";
        Guardarbtn.setToolTipText(texto6);
    ...
    private void initComponents() {
        ...
        jPanel2.add(AgregarProductobtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 100, 50, 40));

        Dimensionaljcmb.setBackground(new java.awt.Color(244, 253, 251));
        Dimensionaljcmb.setFont(new java.awt.Font("Candara", 0, 18)); // NOI18N
        Dimensionaljcmb.setForeground(new java.awt.Color(102, 102, 102));
        Dimensionaljcmb.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        AgregarDimensionalbtn.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        ...
        AgregarDimensionalbtn.setToolTipText("");
        AgregarDimensionalbtn.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        AgregarDimensionalbtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                AgregarDimensionalbtnActionPerformed(evt);
            }
        });
        jPanel2.add(AgregarDimensionalbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 200, 60, 40));
        ...
        jPanel2.add(FechaCalendar, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 300, -1, 125));
    ...
    private void GuardarbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GuardarbtnActionPerformed
        ...
        Cantidadtxt.setText("Cantidad");
        Totaltxt.setText("Total");
        Productojcmb.setSelectedItem("Producto");
    ...
    private void Guardarbtn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Guardarbtn1ActionPerformed
        // TODO add your handling code here:
        EliminarInventario mp = new EliminarInventario();
        mp.setVisible(true);
        dispose();
